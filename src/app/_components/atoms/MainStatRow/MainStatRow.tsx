...
export default function MainStatRow({ description, value, onIconClick }: MainStatRowProps) {
  return (
    <div className="flex items-center justify-between bg-[#F8F6F2] rounded-xl px-6 py-4 mb-4">
      ...
      >
        <svg width="22" height="22" fill="none" viewBox="0 0 22 22">
          <path d="M15 7L7 15M7 7l8 8" stroke="#F04438" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      </button>
    </div>
  );
