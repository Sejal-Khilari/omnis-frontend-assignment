      ...
      <div className="flex items-center gap-4 min-w-[220px] justify-end">
        ...
        <div className="relative">
          <button className="w-11 h-11 flex items-center justify-center rounded-lg bg-white border border-[#EAECF0] hover:bg-gray-50">
            <svg width="22" height="22" fill="none" viewBox="0 0 22 22">
              <path
                d="M11 19.25a2.062 2.062 0 0 1-2.062-2.062h4.124A2.062 2.062 0 0 1 11 19.25Zm7.188-4.125h-1.031V9.625a6.156 6.156 0 0 0-5.125-6.07V2.062a1.031 1.031 0 1 0-2.062 0v1.493a6.156 6.156 0 0 0-5.125 6.07v5.5H3.812a1.031 1.031 0 0 0 0 2.062h15.376a1.031 1.031 0 0 0 0-2.062Z"
                fill="#667085"
              />
            </svg>
        ...
        <div className="flex items-center gap-2 cursor-pointer">
          ...
          <div className="flex flex-col items-start justify-center">
            <span className="text-sm font-medium text-gray-900 leading-4">
              Chi Nguyen
            </span>
          ...
          <svg width="18" height="18" fill="none" viewBox="0 0 18 18">
            <path
              d="M6.75 7.5l2.25 2.25 2.25-2.25"
              stroke="#667085"
              strokeWidth="1.5"
              strokeLinecap="round"
