...
const sidebarItems = [
  ...
  {
    key: "meetings",
    icon: "/sideBarIcons/2.svg",
    alt: "Meetings",
    label: "Meetings",
  },
  {
    key: "status",
    icon: "/sideBarIcons/3.svg",
    alt: "Meeting Status",
    label: "Meeting Status",
  },
  {
    key: "playlist",
    icon: "/sideBarIcons/4.svg",
    alt: "Playlist",
    label: "Playlist",
  },
  {
    key: "contact",
    icon: "/sideBarIcons/5.svg",
    alt: "Contact",
    label: "Contact",
  },
  {
    key: "uploads",
    icon: "/sideBarIcons/6.svg",
    alt: "Uploads",
    label: "Uploads",
  },
];
...
const sidebarMidItems = [
  {
    key: "integrations",
    icon: "/sideBarIcons/1_mid.svg",
    alt: "Integrations",
    label: "Integrations",
  },
  {
    key: "ai_apps",
    icon: "/sideBarIcons/2_mid.svg",
    alt: "AI Apps",
    label: "AI Apps",
  },
  {
    key: "topic_tracker",
    icon: "/sideBarIcons/3_mid.svg",
    alt: "Topic Tracker",
    label: "Topic Tracker",
  },
  {
    key: "analytics",
    icon: "/sideBarIcons/4_mid.svg",
    alt: "Analytics",
    label: "Analytics",
  },
];
...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`bg-[#1A2234] flex flex-col items-center py-4 px-1.5  border-r border-[#E4E7EC] transition-all duration-300 ${
